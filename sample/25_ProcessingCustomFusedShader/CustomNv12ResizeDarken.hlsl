...
// This shader is intentionally application-owned.
// It uses the D3D11Processing HLSL library pieces and fuses multiple steps:
...
void main(uint3 tid : SV_DispatchThreadID)
{
    ...
    Dst[OffsetPosition(DstX, DstY, p)] =
        FromLogicalRgba(float4(rgb, 1.0f), DstFormat);
}
